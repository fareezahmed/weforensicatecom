...
$headers .= 'From:info@weforensicate.com' . "\r\n"; // Sender's Email
...
//mail("fareezahmed@yahoo.co.in", 'Contact Form message from weforensicate.com', $sendmessage1, $headers);
mail("aaan778@gmail.com", 'Contact Form message from weforensicate.com', $sendmessage1, $headers);
echo "Your Query has been received and We will contact you soon. Thank You";
}
} else {
